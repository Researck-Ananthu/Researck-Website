...
import BlobScene from "../components/custom/BlobScene";
const HeroSection = () => {
   return (
      <section
         id="Home"
         data-section="Home"
         className="bg-background text-foreground selection-orange relative h-screen w-full scroll-mt-24 pt-1 xl:pt-3"
      >
         <BlobScene></BlobScene>
