      ...
      >
         ...
         <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            <div className="relative mx-auto mb-10 inline-block px-8 py-10">
               ...
               {/* Heading */}
               <h2
                  className="relative z-10 text-2xl font-extrabold tracking-tight uppercase sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl"
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-8">
               ...
               <button className="group relative transform cursor-pointer rounded-lg bg-black px-6 py-3 font-semibold text-white shadow-md transition-all duration-300 ease-in-out hover:scale-105 dark:bg-white dark:text-black">
                  <span className="absolute -right-0 -bottom-0 z-[-1] h-full w-full rounded-lg bg-orange-300 transition-transform duration-300 group-hover:translate-x-1 group-hover:translate-y-1 dark:bg-orange-300"></span>
                  {buttonStart.text}
               </button>
               {/* Explore */}
