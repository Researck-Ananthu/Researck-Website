    ...
    return (
        ...
        >
            ...
            <div className="group-hover/bento:translate-x-2 transition duration-200 text-neutral-600">
                {/* 1 - Row Content */}
                <div className="mb-2 flex flex-row flex-nowrap items-center justify-between gap-4 font-grotesk">
                    <div className="my-2 inline-flex gap-2 text-base font-bold">
                ...
                <button type={"button"} className="mt-6 w-32 h-12 min-w-32">
                    ...
                    >
                        <span className="relative z-10 block overflow-hidden rounded-lg border-2 border-gray-900 px-5 py-3 font-medium leading-tight text-gray-800 motion-safe:transition-colors motion-safe:duration-300 ease-out motion-safe:group-hover:text-white">
                            {/**/}
                            <span className="absolute inset-0 h-full w-full rounded-lg bg-gray-50 px-5 py-2" />
                            <span className="absolute left-0 -ml-2 h-48 w-48 bg-gray-900 origin-top-right -translate-x-full translate-y-12 -rotate-90 motion-safe:ease-linear motion-safe:transition-all motion-safe:duration-300 motion-safe:group-hover:-rotate-180" />
                            {/**/}
                            {/**/}
                        ...
                        <span
                            className="absolute bottom-0 right-0 -mb-1 -mr-1 h-12 w-full rounded-lg bg-gray-900 transition-all duration-200 ease-in-out group-hover:mb-0 group-hover:mr-0"
