...
const CareerSection = () => {
    return (
        <WhiteSection
            id="career"
            aria-label="CareerSection"
            contentClassName="xl:pt-60 xl:pb-20"
        >
            ...
            <SimpleGridHeading
                ...
                grid={true}
                cover={false}
                startText={careerHeading.headingStart}
                highlightText={careerHeading.headingHighlight}
                endText={careerHeading.headingEnd}
            />
            {/* Close - Heading */}
            ...
            <SimpleParagraph
                whiteScheme={true}
                paragraph1={careerParagraph.paragraphStart}
                paragraph2={careerParagraph.paragraphEnd}
            />
...
const JobContainer = () => {
    return (
        <div className="lg:py-24 md:py-16 py-10 bg-slate-50 rounded-3xl xl:px-0 px-10">
                ...
                {careerJob.openings.map((job, index) => (
                    <div
                        ...
                        className={`flex justify-between gap-x-8 ${
                            index !== careerJob.openings.length - 1
                                ? "py-6 border-b border-gray-200"
                                : "pt-6"
                        }`}
                    >
                        <h3
                            className={`${job.color} text-xl font-medium leading-8`}
                        >
                            {job.title}
                        </h3>
                        <button className="w-20 h-9 rounded-full bg-indigo-50 hover:bg-indigo-100 transition-all duration-700 text-emerald-800 text-xs font-semibold leading-4">
                            Apply
                        </button>
                    </div>
                ))}
        ...
        <div className="xl:max-w-6xl w-auto mx-auto xl:py-28 md:py-16 py-10 xl:px-0 px-10">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-4 lg:gap-x-8 gap-y-4 lg:pb-24 pb-10 border-b border-gray-200 max-w-lg mx-auto md:max-w-3xl lg:max-w-full">
                <div className="p-8 group  hover:rounded-2xl transition-all duration-500 hover:shadow-md cursor-pointer">
                    <div className="w-20 h-20 bg-indigo-50 rounded-xl flex items-center justify-center mb-5 max-lg:mx-auto transition-all duration-500 group-hover:bg-emerald-800">
                        <svg
                            className="fill-emerald-800 transition-all duration-500 group-hover:fill-indigo-50"
                            width="30"
                            height="30"
                            viewBox="0 0 30 30"
                            fill="none"
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 max-lg:text-center">
                        Build your beautiful agency website with us that
                        converts more visitors than any other website and the
                        ability to interact and rotate products to solve user
                        problems.
                    </p>
                </div>
                <div className="p-8 group hover:rounded-2xl transition-all duration-500 hover:shadow-md cursor-pointer">
                    <div className="w-20 h-20 bg-indigo-50 rounded-xl flex items-center justify-center mb-5 max-lg:mx-auto transition-all duration-500 group-hover:bg-emerald-800">
                        <svg
                            className="stroke-emerald-800 transition-all duration-500 group-hover:stroke-indigo-50"
                            width="30"
                            height="30"
                            viewBox="0 0 30 30"
                            fill="none"
            ...
            <div className="lg:mt-24 mt-10 bg-gradient-to-l from-emerald-500 to-emerald-800 p-12 rounded-2xl ">
                <div className="lg:flex items-center justify-between gap-6">
                    ...
                    <button
                        type={"button"}
                        className="px-6 h-14 bg-white rounded-full flex items-center justify-center text-black text-base font-semibold leading-7 gap-2 whitespace-nowrap"
                    >
                        {careerBanner.buttonText}
                        <ArrowRightIcon
                            className="h-5 w-5 -translate-y-[0.05rem]"
                            aria-hidden="true"
                        />
                    </button>
                </div>
