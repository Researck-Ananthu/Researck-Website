...
const SourceCodeWindow: React.FC<SourceCodeWindowProps> = ({
   ...
   return (
      <div
         className={cn(
            "relative z-10 mx-auto h-[420px] w-full max-w-5xl overflow-hidden rounded-xl border-2 border-zinc-500 bg-zinc-800 shadow-2xl lg:h-[600px]",
            className
         )}
      >
         {/* Open - Window bar */}
         ...
         <div className="flex items-center border-b border-zinc-600 bg-zinc-700 px-6 py-3">
            <div className="animate-cursor-blink mr-3 h-4 w-4 rounded-full bg-zinc-500"></div>
            <div className="flex h-8 flex-grow items-center rounded-full bg-zinc-800 px-4">
               <div className="animate-cursor-blink h-2 w-3/4 rounded bg-zinc-400"></div>
            </div>
         </div>
         {/* Close - Search Bar */}
