...
const FocusHighlights = () => {
   ...
   return (
      ...
      >
         ...
         <div className="mx-auto grid w-full max-w-[2000px] grid-cols-1 gap-6 px-4 sm:grid-cols-2 sm:px-6 md:grid-cols-4 md:gap-3 lg:px-6 xl:grid-cols-4 xl:gap-3 2xl:gap-6 2xl:px-0">
            {focuses.map((focus, i) => (
               <motion.div
                  key={focus.title}
