...
import mobileAppDev from "@/assets/images/portfoliogrid/make this image into 16_9 widescreen layout..png";
import webAppDev from "@/assets/images/portfoliogrid/programming-background-with-person-working-with-codes-computer.jpg";
import softwareAppDev from "@/assets/images/portfoliogrid/representation-user-experience-interface-design-computer.jpg";
import healthcareAnalyze from "@/assets/images/portfoliogrid/mobile-phone-stethoscope-chart-file-desktop-mobile-medical-handheld-doctor-concepts.jpg";
import portfolioImg from "@/assets/images/portfoliogrid/top-shot-three-unrecognizable-business-people-sitting-meeting-looking-charts.jpg";
import ecommercePlatform from "@/assets/images/portfoliogrid/showing-cart-trolley-shopping-online-sign-graphic.jpg";
import apiDevelopment from "@/assets/images/portfoliogrid/api_devs.jpg";
import smartHome from "@/assets/images/portfoliogrid/smart_home.jpg";
import aiChatBot from "@/assets/images/portfoliogrid/ai_chat-removebg-preview.png";
import machineLearning from "@/assets/images/portfoliogrid/businessman-working-futuristic-office.jpg";
import saasProject from "@/assets/images/portfoliogrid/saas-concept-collage.jpg";
import pocService from "@/assets/images/portfoliogrid/poc_devs.jpg";
// import projectMigration from "@/assets/images/portfoliogrid/migration.jpg";
import projectManagement from "@/assets/images/portfolio/Project-Management.png";
import machineIntergration from "@/assets/images/portfolio/industrial-iot-solution.svg";
...
export const focuses = [
  {
    title: 'Security',
    description: 'We follow best practices and use cutting-edge encryption to protect data.',
    image: '/images/fun/security.jpg',
    flip_image: '/images/fun/security-2.jpg',
  },
  {
    title: 'Mobile Friendly',
    description: 'Seamless, responsive design optimized for all screen sizes and devices.',
    image: '/images/fun/mobile.jpg',
    flip_image: '/images/fun/mobile-2.jpg',
  },
  {
    title: 'Performance',
    description: 'We build highly optimized applications for blazing fast performance.',
    image: '/images/fun/performance.jpg',
    flip_image: '/images/fun/performance-2.jpg',
  },
  {
    title: 'Powerful APIs',
    description: 'Robust, scalable APIs that enable efficient integration and automation.',
...
export const featureTechnologies = [
    ...
    },
    {
        name: "JavaScript",
        icon: (
            <SiJavascript color="#FACC15" className="size-6 text-yellow-400" />
        ),
...
export const careerFormFields = [
  ...
  { label: "Year of Pass", name: "yearOfPass", type: "number", required: true },
...
export const footerContent = {
    ...
    copyright: {
        ...
        policy: "When you visit or interact with our sites, services or tools, we or our authorized service providers may use cookies for storing information to help provide you with a better, faster, and safer experience and for marketing purposes.",
    },
};
